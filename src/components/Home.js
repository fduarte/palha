            ...
            <div className="home align-content-center text-center">
                ...
                <div className="text-left mt-2 ml-1">
                    ...
                    <ul>
                        ...
                        <li>
                            Single de estreia do novo álbum "Juízo de Valor" - <a href="https://portugarte.pt/2020/06/27/palha-daco-lancam-single-de-estreia-do-novo-album-juizo-de-valor/">Portugarte</a>
                        </li>
                    </ul>
                </div>
            </div>
